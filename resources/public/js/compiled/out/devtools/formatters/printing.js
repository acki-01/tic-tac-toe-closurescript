...
var len__4736__auto___22784 = arguments.length;
var i__4737__auto___22785 = (0);
while(true){
if((i__4737__auto___22785 < len__4736__auto___22784)){
args__4742__auto__.push((arguments[i__4737__auto___22785]));

var G__22786 = (i__4737__auto___22785 + (1));
i__4737__auto___22785 = G__22786;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22781){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22782,G__22783,seq22781__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22787_SHARP_){
return (!((cljs.core.meta.call(null,p1__22787_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22788__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22792){var _e__22015__auto__ = e22792;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e22794){var _e__22015__auto__ = e22794;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22796 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22797 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22797);

try{var map__22798 = opts;
...
var markup_db = cljs.core.get.call(null,map__22798__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22796);
}});
...
var temp__5718__auto___22803 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___22803)){
var managed_print_level_22804 = temp__5718__auto___22803;
var _STAR_print_level_STAR__orig_val__22801_22805 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22802_22806 = managed_print_level_22804;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22802_22806);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22800_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22800_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22801_22805);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1611781632278
