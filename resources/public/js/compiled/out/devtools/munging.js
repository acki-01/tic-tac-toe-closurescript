...
var o22650 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22650["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22651 = temp__5718__auto____$1;
return (o22651["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22008__auto__ = f;
return (o__22008__auto__["toString"]).call(o__22008__auto__);
} else {
return "";
}
}catch (e22652){var _ = e22652;
return "";
}});
...
try{var o__22008__auto___22654 = t;
(o__22008__auto___22654["cljs$lang$ctorPrWriter"]).call(o__22008__auto___22654,t,writer);
}catch (e22653){var __22655 = e22653;
}
...
var char_code = (function (){var o__22008__auto__ = (new String(char$));
return (o__22008__auto__["charCodeAt"]).call(o__22008__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22008__auto__ = String;
return (o__22008__auto__["fromCharCode"]).call(o__22008__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22656 = num_code;
switch (G__22656) {
case (1):
return (185);
...
var o__22008__auto__ = String;
return (o__22008__auto__["fromCharCode"]).call(o__22008__auto__,superscript_code);
});
/**
...
}catch (e22658){var _e__22015__auto__ = e22658;
return false;
}})())){
...
var vec__22659 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22659,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22662 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22662["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22663 = temp__5718__auto____$1;
return (o22663["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___22670 = arguments.length;
var i__4737__auto___22671 = (0);
while(true){
if((i__4737__auto___22671 < len__4736__auto___22670)){
args__4742__auto__.push((arguments[i__4737__auto___22671]));

var G__22672 = (i__4737__auto___22671 + (1));
i__4737__auto___22671 = G__22672;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22666){
var vec__22667 = p__22666;
var ns_detector = cljs.core.nth.call(null,vec__22667,(0),null);
...
var G__22673 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22674 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22673;
remaining_tokens = G__22674;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22664){
var G__22665 = cljs.core.first.call(null,seq22664);
var seq22664__$1 = cljs.core.next.call(null,seq22664);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22665,seq22664__$1);
}));
...
var vec__22678 = cljs.core.split_with.call(null,(function (p1__22677_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22677_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22678,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22678,(1),null);
...
var vec__22684 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22684,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22684,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22687 = cljs.core.rest.call(null,remaining_tokens);
var G__22688 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22687;
name_tokens = G__22688;
continue;
} else {
...
var vec__22691 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22691,(0),null);
var arity = cljs.core.nth.call(null,vec__22691,(1),null);
var vec__22694 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22694,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22694,(1),null);
var vec__22697 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22697,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22697,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22697,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22697,(3),null);
...
var vec__22703 = result;
var munged_ns = cljs.core.nth.call(null,vec__22703,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22703,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22703,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22703,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22703,(4),null);
var arity = cljs.core.nth.call(null,vec__22703,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22707 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22707,(0),null);
var args = cljs.core.nth.call(null,vec__22707,(1),null);
var vec__22710 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22710,(0),null);
var name = cljs.core.nth.call(null,vec__22710,(1),null);
...
var G__22713 = (arity + (1));
var G__22714 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22715){
var vec__22716 = p__22715;
var arity = cljs.core.nth.call(null,vec__22716,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22716,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22719_SHARP_){
return cljs.core.get.call(null,arities,p1__22719_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22720_SHARP_){
return cljs.core.drop.call(null,(2),p1__22720_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22727 = arguments.length;
var i__4737__auto___22728 = (0);
while(true){
if((i__4737__auto___22728 < len__4736__auto___22727)){
args__4742__auto__.push((arguments[i__4737__auto___22728]));

var G__22729 = (i__4737__auto___22728 + (1));
i__4737__auto___22728 = G__22729;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22723){
var vec__22724 = p__22723;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22724,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22721){
var G__22722 = cljs.core.first.call(null,seq22721);
var seq22721__$1 = cljs.core.next.call(null,seq22721);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22722,seq22721__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22732__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22732__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22732__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22732__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22733 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22733,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22733,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22733,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22733,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22733,(4),null);
var arity = cljs.core.nth.call(null,vec__22733,(5),null);
...
var o__22008__auto__ = f;
return (o__22008__auto__["getBasis"]).call(o__22008__auto__);
});
/**
...
}catch (e22737){var _e__22015__auto__ = e22737;
...
var G__22738 = (obj[cljs.core.first.call(null,path)]);
var G__22739 = cljs.core.rest.call(null,path);
obj = G__22738;
path = G__22739;
continue;
} else {
...
var _STAR_ = (function (accum,p__22740){
var vec__22741 = p__22740;
var bit = cljs.core.nth.call(null,vec__22741,(0),null);
var protocol = cljs.core.nth.call(null,vec__22741,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22744){
var vec__22745 = p__22744;
var ns = cljs.core.nth.call(null,vec__22745,(0),null);
var name = cljs.core.nth.call(null,vec__22745,(1),null);
var selector = cljs.core.nth.call(null,vec__22745,(2),null);
...
var post_process = (function (p__22749){
var vec__22750 = p__22749;
var munged_name = cljs.core.nth.call(null,vec__22750,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22750,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22748_SHARP_){
return (obj[cljs.core.first.call(null,p1__22748_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1611781632118
